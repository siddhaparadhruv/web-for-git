	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4 mb-5 px-4">
				<div class="bg-white p-3 p-md-4 rounded shadow-sm">
					<form id="profile-form">
						...
						<label class="mt-1 form-label">New Picture</label>
		    			<input name="profile" type="file" class=" mb-4 form-control shadow-none" accept=".jpg,.jpeg,.png,.webp" required>
			...
			<div class="col-md-4 mb-5 px-4">
				<div class="bg-white p-3 p-md-4 rounded shadow-sm">
					<form id="pass-form">
						<h5 class="mb-3 fw-bold">Chenge Password</h5>
						<div class="row">
