...
<body class="bg-light">
	...
	<div class="container">
		<div class="row">
			...
			<?php
				...
				INNER JOIN `booking_details` bd ON bo.booking_id = bd.booking_id WHERE ((bo.booking_status ='booked')
					...
					echo<<<bookings
						<div class="col-md-4 px-4 mb-4">
							<div class="bg-white p-3 rounded shadow-sm">
								...
								<p>
									<span class="badgr $status_bg">$data[booking_status]</span>
								</p>
								$btn
							</div>
						</div>
	...
	<div class="modal fade mt-5" id="reviewModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" >
