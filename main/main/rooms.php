...
<body class="bg-light">
							...
							<div class="border bg-light p-3 rounded mb-3">
								...
								<?php
									...
									while($row = mysqli_fetch_assoc($facilities_q)){
										echo<<<facilities
										<div class="mb-2">
											<input onclick="fetch_rooms()" name="facilities" value="$row[id]" type="checkbox" id="$row[id]" class="form-check-input shadow-none me-1">
							...
							<div class="border bg-light p-3 rounded mb-3">
								...
								<div class="d-flex">
									<div class="me-3">
										...
										<input type="number" min="1" value="<?php echo $adult_default ?>" id="adults" class="form-control shadow-none" oninput="guests_filter()">
									</div>
									<div>
										<label class="form-label">Children</label>
										<input type="number" min="1" value="<?php echo $children_default ?>" id="children" class="form-control shadow-none" oninput="guests_filter()">
									</div>
								</div>
							</div>
						</div>
	...
	<script>
		...
		function fetch_rooms() {
			...
			xhr.open("GET", "ajax/rooms.php?fetch_rooms&chk_avail="+chk_avail+"&guests="+guests+"&facility_list="+facilities_list, true);
